...
export default function ReadPage() {
  ...
  // READ books (different source than Library)
  const books = userReadBooks();
                ...
                return (
                  <div key={book.id} className="lib-col">
                    <div
                      ...
                      // ensure pointer cursor (in case CSS gets overridden)
